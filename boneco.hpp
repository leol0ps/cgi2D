...
public:
    ...
    bool ColisaoX(GLdouble time, Direction direction, GLfloat inimigoX, GLfloat inimigoY);
    bool ColisaoY(GLdouble time, Direction direction, GLfloat inimigoX, GLfloat inimigoY);
